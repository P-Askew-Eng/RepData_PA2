...
```
There are now there are **`r length(levels(storm$EVTYPE)) `** categories which is an improvement but still not ideal and further detaile dexamination would be required.
